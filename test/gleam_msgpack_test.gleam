...
import msgpack/types.{
  ...
  PackedNil, PackedString, PackedValue, max_arr16_len, max_bin16_len, max_bin8_len,
  max_fixarr_len, max_fixstr_len, max_int16, max_int32, max_int64, max_int8, max_str16_len,
  max_str8_len, max_uint16, max_uint32, max_uint64, max_uint8, min_arr16_len, min_arr32_len,
  min_bin16_len, min_bin32_len, min_bin8_len, min_fixarr_len, min_fixstr_len, min_int16,
  min_int32, min_int64, min_int8, min_str16_len, min_str32_len, min_str8_len, min_uint16,
  min_uint32, min_uint64, min_uint8,
}
...
pub fn encode_string_test() {
  ...
  encode_test(
    decoded_fixture(min_fixstr_len),
    <<0b101:3, min_fixstr_len:5, encoded_fixture(min_fixstr_len):utf8>>,
  )

  encode_test(
    decoded_fixture(max_fixstr_len),
    <<0b101:3, max_fixstr_len:5, encoded_fixture(max_fixstr_len):utf8>>,
  )

  encode_test(
    decoded_fixture(min_str8_len),
    <<0xd9, min_str8_len:8, encoded_fixture(min_str8_len):utf8>>,
  )

  encode_test(
    decoded_fixture(max_str8_len),
    <<0xd9, max_str8_len:8, encoded_fixture(max_str8_len):utf8>>,
  )

  encode_test(
    decoded_fixture(min_str16_len),
    <<0xda, min_str16_len:16, encoded_fixture(min_str16_len):utf8>>,
  )

  encode_test(
    decoded_fixture(max_str16_len),
    <<0xda, max_str16_len:16, encoded_fixture(max_str16_len):utf8>>,
  )

  encode_test(
    decoded_fixture(min_str32_len),
    <<0xdb, min_str32_len:32, encoded_fixture(min_str32_len):utf8>>,
  )
...
pub fn encode_binary_test() {
  ...
  encode_test(
    decoded_fixture(min_bin8_len),
    <<0xd9, min_bin8_len:8, encoded_fixture(min_bin8_len):bit_string>>,
  )

  encode_test(
    decoded_fixture(max_bin8_len),
    <<0xd9, max_bin8_len:8, encoded_fixture(max_bin8_len):bit_string>>,
  )

  encode_test(
    decoded_fixture(min_bin16_len),
    <<0xda, min_bin16_len:16, encoded_fixture(min_bin16_len):bit_string>>,
  )

  encode_test(
    decoded_fixture(max_bin16_len),
    <<0xda, max_bin16_len:16, encoded_fixture(max_bin16_len):bit_string>>,
  )

  encode_test(
    decoded_fixture(min_bin32_len),
    <<0xdb, min_bin32_len:32, encoded_fixture(min_bin32_len):bit_string>>,
  )
...
pub fn decode_int_test() {
  ...
  // uints
  decode_test(<<0xcc, min_uint8:8>>, PackedInt(min_uint8))
  decode_test(<<0xcc, max_uint8:8>>, PackedInt(max_uint8))
  ...
  // ints
  decode_test(<<0xd0, min_int8:8>>, PackedInt(min_int8))
  decode_test(<<0xd0, max_int8:8>>, PackedInt(max_int8))
...
pub fn decode_binary_test() {
  ...
  decode_test(
    <<0xc4, min_bin8_len:8, encoded_fixture(min_bin8_len):bit_string>>,
    decoded_fixture(min_bin8_len),
  )

  decode_test(
    <<0xc4, max_bin8_len:8, encoded_fixture(max_bin8_len):bit_string>>,
    decoded_fixture(max_bin8_len),
  )

  decode_test(
    <<0xc5, min_bin16_len:16, encoded_fixture(min_bin16_len):bit_string>>,
    decoded_fixture(min_bin16_len),
  )

  decode_test(
    <<0xc5, max_bin16_len:16, encoded_fixture(max_bin16_len):bit_string>>,
    decoded_fixture(max_bin16_len),
  )

  decode_test(
    <<0xc6, min_bin32_len:32, encoded_fixture(min_bin32_len):bit_string>>,
    decoded_fixture(min_bin32_len),
  )
  // max_bin32_len omitted for performance
}
...
pub fn decode_ext_test() {
  ...
  decode_test(
    <<0xd4, ext_type:8, ext_data:bit_string>>,
